...
if ($dataAtletas = $atleta->readFederaciones()) {
    ...
    $pdf->cell(21, 10, 'Nacimiento', 1, 0, 'C', 1);
        ...
        if ($atleta->setFederacion($rowAtleta['idfederacion'])) {
            ...
            if ($dataAtletas = $atleta->readAtletasFederacion()) {
                ...
                foreach ($dataAtletas as $rowAtleta) {
                    ...
                    $pdf->cell(50, 10, $pdf->encodeString($rowAtleta['nombre_atleta']), 1, 0);
                    $pdf->cell(50, 10, $pdf->encodeString($rowAtleta['apellido_atleta']), 1, 0);
                    $pdf->cell(21, 10, $rowAtleta['nacimiento'], 1, 0);
