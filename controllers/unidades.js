...
const UNIDADES_API = 'business/unidades.php';
        ...
        JSON.dataset.forEach(row => {
            ...
            TBODY_ROWS.innerHTML += `
                <tr>
                    ...
                    <td>
                        <a onclick="openUpdate(${row.idunidad_medida})" data-bs-toggle="modal" data-bs-target="#save-modal" class="btn btn-primary tooltipped" data-tooltip="Actualizar">
                    ...
                    <td>
                        <a onclick="openDelete(${row.idunidad_medida})" class="btn btn-danger tooltipped" data-tooltip="Eliminar">
...
function openCreate() {
    ...
    MODAL_TITLE.textContent = 'Ingresar una unidad de medida';
}
...
async function openUpdate(id) {
    ...
    if (JSON.status) {
        ...
        SAVE_FORM.reset();
        // Se asigna título a la caja de diálogo.
        MODAL_TITLE.textContent = 'Actualizar unidad de medida';
...
async function openDelete(id) {
    ...
    const RESPONSE = await confirmAction('¿Desea eliminar la unidad de medida de forma permanente?');
