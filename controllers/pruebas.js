        ...
        JSON.dataset.forEach(row => {
            ...
            TBODY_ROWS.innerHTML += `
                <tr>
                    ...
                    <td>
                    <a onclick="openUpdate(${row.idprueba})" data-bs-toggle="modal" data-bs-target="#save-modal" class="btn btn-primary tooltipped" data-tooltip="Actualizar">
                ...
                <td>
                    <a onclick="openDelete(${row.idprueba})" class="btn btn-danger tooltipped" data-tooltip="Eliminar">
...
function openCreate() {
    ...
    MODAL_TITLE.textContent = 'Crear prueba';
...
async function openUpdate(id) {
    ...
    if (JSON.status) {
        ...
        MODAL_TITLE.textContent = 'Actualizar prueba';
        // Se inicializan los campos del formulario.
        document.getElementById('id').value = JSON.dataset.idprueba;
        fillSelect(DEPORTE_API, 'readAll', 'producto', JSON.dataset.iddeporte);
        fillSelect(EVENTO_API, 'readAll', 'talla', JSON.dataset.idevento);
